...
#./control_db_loopbk.sh C D $pd_kunle $kunle_bk kunleadexsr@gmail.com APEXDB kunle Y 'select username from all users where username like '%SEPT21%';'
#./control_db_loopbk.sh H D (Database Backup- Human Interactive)
#./control_db_loopbk.sh C F $pd_kunle $kunle_bk kunleadexsr@gmail.com (File or Directory Backup USING CRON)
#./control_db_loopbk.sh H F  $pd_kunle $kunle_bk kunleadexsr@gmail.com
...
. /home/oracle/scripts/oracle_env_APEXDB.sh
   ...
   then
       ...
       spool '/home/oracle/scripts/practicedir_kunle_dec21/db_schema_list.log'
       --${SQLSTATEMENT}
       select username from all_users where username like '%SEPT21%';
